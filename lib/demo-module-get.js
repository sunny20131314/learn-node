...
import defaultFn, {setName, sayName as say, firstName, lastName, year, jquery} from './demo-module';

import * as circle from './demo-module';
...
import {foo, incFoo} from './demo-module';
console.log( foo, 'foo~~~~~~~~~' );
incFoo();
...
import customName from './demo-module';
console.log( customName, 'customName' );
console.log( customName(), 'customName()' );

// import 和 export 的结合体: 在导入的同时, 导出! import 默认会提升要当前页面顶部!!
export { sayHello as say } from './demo-module';
