...
// /Users/sunzhimin/Documents/workspace/wlw/just-write
// /Users/sunzhimin/Documents/workspace/learn-node/lib/demo-filesystem-operate.js
console.log( __dirname );
console.log( process.argv );
strToGbk(path.join(__dirname, '../../wlw/just-write/test.html'), path.join(__dirname, '../../wlw/just-write/test-gbk.html'));
strToGbk(path.join(__dirname, '../../wlw/just-write/test.xml'), path.join(__dirname, '../../wlw/just-write/test-gbk.xml'));
